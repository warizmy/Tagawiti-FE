...
class Product2 {
  ...
  _render() {
    document.title = 'Website Desa Tagawiti - Fish Floss';
        ...
        <div class="product-box w-100 p-2">
          <div class="d-flex flex-row gap-4 p-3 product-box-content">
            <div class="w-100 product-image-container">
              <img src="./images/market/product3.webp">
            </div>
            <div class="d-flex flex-column gap-2">
              <div class="d-flex flex-column product-text-header">
                <h3 class="fw-semibold mb-1">Fish Floss</h3>
                <p class="text-secondary fs-6">Abon Ikan Khas Desa Tagawiti</p>
              </div>
              <div class="d-flex flex-column product-text-description">
                <p class="text-wrap">
                  Nikmati kelezatan autentik Abon Ikan Khas Desa Tagawiti, olahan tradisional dari daging ikan segar yang dipadukan dengan racikan bumbu alami khas Indonesia. 
                  Dibuat dengan bahan berkualitas seperti santan, rempah-rempah, dan daun jeruk, abon ini menghadirkan rasa gurih, pedas, dan aroma harum yang menggoda. 
                  Tanpa bahan pengawet, abon ikan ini cocok untuk teman makan nasi, taburan mi, atau camilan langsung. Praktis, lezat, dan kaya gizi, 
                  Abon Ikan Tagawiti adalah pilihan sempurna untuk Anda yang ingin membawa kelezatan Nusantara ke meja makan Anda.
                </p>
              </div>
              <ul class="d-flex flex-column gap-1">
                  <li><span class="fw-semibold">Komposisi</span> : Daging Ikan, Santan, Gula, Minyak, Garam, Cabe, Bawang Merah, Bawang Putih, Lengkuas, Daun Jeruk, Kunyit, Jahe, Lada, Kemiri, Sereh.</li>
